<div class="slips index">
	<h2><?php echo __('Slips'); ?></h2>
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $slip['Slip']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $slip['Slip']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
