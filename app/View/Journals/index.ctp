<div class="journals index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('slip_id'); ?></th>
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($journal['Slip']['id'], array('controller' => 'slips', 'action' => 'view', $journal['Slip']['id'])); ?>
		</td>
		<td><?php echo h($journal['Journal']['date']); ?>&nbsp;</td>
		<td><?php echo h($journal['Journal']['subject']); ?>&nbsp;</td>
		<td><?php echo h($journal['Journal']['amount']); ?>&nbsp;</td>
		<td><?php echo h($journal['Journal']['note']); ?>&nbsp;</td>
